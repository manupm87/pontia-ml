...
sin pagar el coste dimensional.
...
cruzada. TensorFlow solo se usa al entrenar la red; en producción se sirve XGBoost.
...
incluía dos fugas de \emph{check-in} (sección 2): \var{required\_car\_parking\_spaces}
y \var{assigned\_room\_type}. Al eliminar ambas, la cifra \emph{honesta} baja a
$0.9529$. Las variables derivadas \var{has\_company}/\var{has\_agent} y la reducción
de cardinalidad recuperan la mayor parte de la señal perdida.
