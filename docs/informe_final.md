...
| **Joaquin Castro Salas** (*jcastrosalas03@gmail.com*) |
...
de _check-in_ (sección 2): `required_car_parking_spaces` y `assigned_room_type`. Al eliminar
ambas, la cifra _honesta_ baja a 0.9529. Las variables derivadas
...
_Regiones de decisión de los cinco modelos sobre una proyección 2D supervisada (PLS). Permite comparar visualmente la frontera que aprende cada familia de algoritmos sobre el mismo plano._
...
_Reproducibilidad._ Los resultados se generan con
